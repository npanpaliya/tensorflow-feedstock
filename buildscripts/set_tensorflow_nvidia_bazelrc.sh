...
set -ex
BAZEL_RC_DIR=$1
CUDA_TOOLKIT_PATH=$CONDA_PREFIX,$PREFIX
...
build --action_env TF_CUDA_PATHS="$CUDA_TOOLKIT_PATH,$OPEN_CE_CUDA_HOME"
build --action_env CUDA_TOOLKIT_PATH="$CUDA_TOOLKIT_PATH,$OPEN_CE_CUDA_HOME"
